...
export default function EditProfileOverlay() {
    ...
    const cropAndUpdateImage = async () => {
        ...
        try {
            ...
            await useUpdateProfileImage(currentProfile?.id || '', newImageId, file)
                                    ...
                                    <div className="flex items-center justify-center sm:-mt-6">
                                        <div className="sm:w-[60%] w-full max-w-md">
                                            ...
                                            <p className={`relative text-[11px] text-gray-500 ${error ? 'mt-1' : 'mt-4'}`}>
                                                ชื่อผู้ใช้สามารถประกอบด้วยตัวอักษร, ตัวเลข, เครื่องหมายขีดล่าง, และจุดเท่านั้น การเปลี่ยนชื่อผู้ใช้จะทำให้ลิงก์โปรไฟล์ของคุณเปลี่ยนไปด้วย
                                            </p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    >
                        {!uploadedImage ? (
                            ...
                            <div id="CropperButtons" className="flex items-center justify-end" >
                                ...
                                >
                                    <span className="mx-4 font-medium text-[15px]">
                                        {isUpdating ? <BiLoaderCircle color="#ffffff" className="my-1 mx-2.5 animate-spin" /> : "ใช้"}
                                    </span>
                                </button>
