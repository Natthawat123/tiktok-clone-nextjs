...
import { Add as AddIcon, Search as SearchIcon, MoreVert as MoreVertIcon, PersonOutlineOutlined as PersonOutlineOutlinedIcon, LogoutOutlined as LogoutOutlinedIcon } from '@mui/icons-material';
                ...
                <div className={`flex items-center justify-between gap-6 w-full px-4 mx-auto ${pathname === '/' ? 'max-w-[1150px]' : ''}`}>
                    ...
                    <div className="relative hidden md:flex items-center justify-end bg-[#F1F1F2] p-1 rounded-full max-w-[430px] w-full">
                        ...
                        <div className="px-3 py-1 flex items-center border-l border-l-gray-300">
                            <SearchIcon className="text-[#A1A2A7]" fontSize="medium" />
                        </div>
                    </div>
                    ...
                    <div className="flex items-center gap-3 ">
                        ...
                        >
                            <AddIcon className="text-[#A1A2A7]" fontSize="medium" />
                            <span className="px-2 font-medium text-[15px]">อัปโหลด</span>
                        </button>
                        ...
                        {!userContext?.user?.id ? (
                            <div className="flex items-center">
                                ...
                                >
                                    <span className="whitespace-nowrap mx-4 font-medium text-[15px]">เข้าสู่ระบบ</span>
                                </button>
                                <MoreVertIcon className="text-[#A1A2A7]" fontSize="medium" />
                            </div>
                        ) : (
                            <div className="flex items-center">
                                    ...
                                    {showMenu ? (
                                        <div className="absolute bg-white rounded-lg py-1.5 w-[200px] shadow-xl border top-[40px] right-0">
                                            ...
                                            >
                                                ...
                                                <span className="pl-2 font-semibold text-sm">ออกจากระบบ</span>
                                            </button>
                                        </div>
                                    ) : null}
                                </div>
